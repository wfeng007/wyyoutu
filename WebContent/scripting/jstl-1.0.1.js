...
*/
    ...
    */
     ...
     * };
     * var Duck = Clazz.create(Animal, function(){
     *    this.swim = function(){
     ...
     * @return Object
     */
    Clazz.create = function(parent, constructor){
        var clazz = null;
        ...
        if(parent != null)
        {
            if(constructor != null)
            {
                clazz = function(){/* Clazz.create */ parent.apply(this, arguments); this.$super = Clazz.$super(this, parent.prototype); constructor.apply(this, arguments);};
            }
            else
            {
                clazz = function(){/* Clazz.create */ parent.apply(this, arguments); this.$super = Clazz.$super(this, parent.prototype);};
            }
        ...
        else
        {
            if(constructor != null)
            {
                clazz = function(){/* Clazz.create */ this.$super = {}; constructor.apply(this, arguments);};
            }
            else
            {
                clazz = function(){/* Clazz.create */ this.$super = {};};
            }
        }
     ...
     * @retur Object
     */
    Clazz.$super = /* private */ function(instance, prototype){
        var object = {};
    ...
    /**
     * simple singleton
     * var myduck = Clazz.getInstance(Animal, function(){this.swim = function(){};});
     * myduck.swim();
     * @param parent
     * @param constructor
     * @return Object
     */
    Clazz.getInstance = function(parent, constructor){
        return new (Clazz.create(parent, constructor))();
    };
     ...
     * @return Object
     */
    Clazz.extend = function(child, parent){
        if(child == null)
        {
            child = {};
        }
...
(function(){
     ...
     * Use is subject to license terms.
     */
    jsp.compile.JspCompiler = Clazz.create(com.skin.html.HtmlParser);
    ...
    jsp.compile.JspCompiler.prototype.startTag = function(){
        ...
        else if(this.stream.peek() != "!")
        {
            ...
            if(tagLibrary != null && tagLibrary.getTagClazzName(nodeName) != null)
            {
                var tagClazzName = tagLibrary.getTagClazzName(nodeName);
                var parent = stack.peek();
                var flagName = "_flag_" + (this.flagIndex++);
                var tagInstanceName = "_tag_instance_" + (this.tagInstanceIndex++);
                var tagInfo = {"className": tagClazzName, "instanceName": tagInstanceName, "flagName": flagName};
                stack.push(tagInfo);
                ...
                else if(tagClazzName == "jsp.taglib.core.OutTag")
                {
                    var expr = this.exprPool.parse(attributes["value"]);
                    this.writer.write("var " + tagInstanceName + " = new " + tagClazzName + "();");
                ...
                else if(tagClazzName == "jsp.taglib.core.ForEachTag")
                {
                ...
                else if(tagClazzName == "jsp.taglib.core.ChooseTag")
                {
                    this.writer.write("var " + tagInstanceName + " = new " + tagClazzName + "();");
                ...
                else if(tagClazzName == "jsp.taglib.core.WhenTag")
                {
                    var expr = this.exprPool.create(attributes["test"]);
                ...
                else if(tagClazzName == "jsp.taglib.core.OtherwiseTag")
                {
    ...
    jsp.compile.JspCompiler.prototype.endTag = function(nodeName){
        ...
        if(tagLibrary != null && tagLibrary.getTagClazzName(nodeName) != null)
        {
            ...
            if(tag.tagClazzName == tagClazzName)
            {
                stack.pop();
            }
            else
    ...
    jsp.runtime.ScriptletFactory.create = function(scriptlet){
        ...
        return Clazz.extend(new jsp.scriptlet.Scriptlet(), scriptlet);
    };
